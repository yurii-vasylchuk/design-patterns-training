 ...
 * инициализироваться аргументом, переданным в конструктор. После этого реализуем методы getData() и getHeaders().
 * </p>
 * <p>
 ...
 * класс - оцени, насколько легко было это сделать. А также оцени, тот момент, что код базового класса ReportGenerator
 * не изменился, как и код класса BankAccountReportGenerator - то есть, расширение функциональности не привело к
